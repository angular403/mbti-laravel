		...
		<div class="card-body px-lg-5 pt-4">
			<form action="{{url('/test')}}" method="post">
				...
				<div class="form-group row">
					...
					<div class="col-sm-10">
						<input type="text" autocomplete="off" class="form-control" name="nama" placeholder="Nama lengkap" value="{{old('nama')}}">
				...
				<div class="form-group row">
					...
					<div class="col-sm-10">
						<input type="number" autocomplete="off" value="{{old('usia')}}" class="form-control" name="usia" placeholder="Usia">
				...
				<div class="form-group row">
					...
					<div class="col-sm-10">
						<input type="email" autocomplete="off" value="{{old('email')}}" class="form-control" name="email" placeholder="Email">
